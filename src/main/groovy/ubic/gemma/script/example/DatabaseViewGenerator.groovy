...
differentialExpressionResultService = sx.getBean(DifferentialExpressionResultService.class)
differentialExpressionAnalysisService = sx.getBean(DifferentialExpressionAnalysisService.class)
compositeSequenceService = sx.getBean(CompositeSequenceService.class)
expressionExperimentService = sx.getBean(ExpressionExperimentService.class)
 ...
 * @return
 */
File getViewFile(String datasetDiffexViewBasename) {
        ...
        for (DifferentialExpressionAnalysis analysis : results) {
            ...
            for (ExpressionAnalysisResultSet ears : analysis.getResultSets()) {
                ...
                for (ExperimentalFactor ef : ears.getExperimentalFactors()) {
                    ...
                    if (ef.getCategory().getCategoryUri() != null) {
                        factorURI += ef.getCategory().getCategoryUri() + ","
                    }
                }
